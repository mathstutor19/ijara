...
function Services() {
  return (
    <Section>
      <Container>
        <h2 className="services-title heading-two">Bizning hizmatlarimiz</h2>
        <div className="services-cards">
          <Link to="/uylar">
            <div className="services-card">
              ...
              <h3 className="services-card-title heading-three">
                Uy topish hizmati
              </h3>
            </div>
          </Link>
